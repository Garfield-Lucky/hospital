...
<style>
 ...
 <script src="js/common/personInfo.js"></script>
<body>
 <form class="form-inline" role="form">
	<div class="row">
		<div class="col-lg-4">
			姓名：<input type="text" value="${user.userName}" class="form-control userName" readonly="readonly" placeholder="姓名">
		</div>
		<div class="col-lg-4">
	...
	<div class="row">
		...
		<div class="col-lg-4">
			身份证号：<input type="text" value="${user.idCard}" class="form-control idCard" readonly="readonly" placeholder="身份证号">
		</div>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			医疗卡号：<input type="text" value="${user.medicalNum}" class="form-control medicalNum" readonly="readonly" placeholder="医疗卡号">
		</div>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			账号余额：<input type="text" value="${user.balanceMedical}" class="form-control balanceMedical" readonly="readonly" placeholder="账号余额">
		</div>
	</div>
	<div class="row">
		<div class="col-lg-4">
