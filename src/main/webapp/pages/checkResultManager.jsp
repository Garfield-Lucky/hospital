...
<link rel="stylesheet" type="text/css" href="css/check/checkResultManager.css">
<body>
<div class="query" >
...
<script src="js/check/checkResultManager.js"></script>
<script id="departmentList4" type="text/x-handlebars-template">
 ...
 <tr>
  ...
  <td>{{checkType}}</td>
  <td>{{status}}</td>
  <td> <a><span class="glyphicon glyphicon-search see" data-content="{{checkResult}}" data-userId="{{userId}}" data-userName="{{userName}}" data-photo="{{checkPhoto}}"></span></a></td>
  <td>{{doctorName}}</td>
  <td>{{createTime}}</td>
  <td>{{checkTime}}</td>
  <td>{{checkPerson}}</td>
  <td><a data-id={{id}} data-content="{{checkResult}}" data-userId="{{userId}}" data-userName="{{userName}}" class="glyphicon glyphicon-edit update po"></a> </td>
 </tr>
 {{/each}}
</script>  
</body>
