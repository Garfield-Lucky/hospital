...
$(function(){
	 ...
	 $(".query").find('.find').click(function(){
		 ...
		 $.ajax({
				...
				success : function(data) {
					if (data.status == "0000") {
						...
						$('#baiyao_list').html(departmentList4(data.list));
	  ...
	  $("#session1").on('click','.baiyao',function(){
		 var vistId = $(this).attr('data-vistId');
		 var userId = $(this).attr('data-userId');
		 var userName = $(this).attr('data-userName');
 		 $('.mainbody_right').load("pres/showMedicine.do",{vistId:vistId,userId:userId,userName:userName});
 	     });
